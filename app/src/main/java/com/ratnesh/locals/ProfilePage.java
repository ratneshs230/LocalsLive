    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textCart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(ProfilePage.this,Cart.class);
                startActivity(intent);
            }
        });
        textOrder.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(ProfilePage.this,All_Orders.class);
                startActivity(intent);
            }
        });
        signOutText.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor.apply();
                Intent intent=new Intent(ProfilePage.this,Login_Phone.class);
