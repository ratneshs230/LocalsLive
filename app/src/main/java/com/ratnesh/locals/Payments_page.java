...
Payments_page extends AppCompatActivity {
    ...
    TextView cartTotal,cartItems,totalCharge;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences mypref=getSharedPreferences("Local_preference",MODE_PRIVATE);
        ...
        address=mypref.getString("add1","")+","+mypref.getString("add2","")+","+mypref.getString("add3","");
        ...
        cartItemsEdit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(Payments_page.this,Cart.class);
                startActivity(intent);
            }
        });
